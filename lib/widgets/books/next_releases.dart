...
class NextReleases extends StatefulWidget {
  NextReleases({super.key});

  @override
  State<NextReleases> createState() => _NextReleasesState();
}

class _NextReleasesState extends State<NextReleases> {
      ...
      builder:
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
            ...
            itemCount: reversedBooks.take(10).length,
